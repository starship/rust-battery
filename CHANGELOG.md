...
## [0.12.0](https://github.com/starship/rust-battery/compare/v0.11.1...v0.12.0) - 2026-09-21
...
- prevent battery iterator from failing if first battery is missing on Windows ([#163](https://github.com/starship/rust-battery/pull/163))

### Other

- *(deps)* update taiki-e/install-action action to v2.87.13 ([#172](https://github.com/starship/rust-battery/pull/172))
- *(deps)* update release-plz/action action to v0.5.137 ([#171](https://github.com/starship/rust-battery/pull/171))
- *(deps)* update rust crate cfg-if to 1.0.5
- *(deps)* update zizmorcore/zizmor-action action to v0.6.4 ([#170](https://github.com/starship/rust-battery/pull/170))
- *(deps)* update taiki-e/install-action action to v2.87.9 ([#169](https://github.com/starship/rust-battery/pull/169))
- *(deps)* update release-plz/action action to v0.5.135
- *(deps)* update rust crate plist to ~1.10.1
- *(deps)* update zizmorcore/zizmor-action action to v0.6.3 ([#166](https://github.com/starship/rust-battery/pull/166))
- *(deps)* update taiki-e/install-action action to v2.87.4
- *(deps)* update rust crate mach to ^0.7.0
- *(deps)* update taiki-e/install-action action to v2.87.0
- *(deps)* update rust crate schemars to 1.2.2 ([#161](https://github.com/starship/rust-battery/pull/161))
- *(deps)* update taiki-e/install-action action to v2.86.8 ([#158](https://github.com/starship/rust-battery/pull/158))
- *(deps)* update embarkstudios/cargo-deny-action action to v2.1.1 ([#157](https://github.com/starship/rust-battery/pull/157))
- *(deps)* update actions/checkout action to v7.0.1 ([#155](https://github.com/starship/rust-battery/pull/155))
...
* bump deps & msrv and handle windows clippy warnings ([#95](https://github.com/starship/rust-battery/issues/95)) ([c9a829e](https://github.com/starship/rust-battery/commit/c9a829e3435401a3192471642eb0e36e413fe4c2))
