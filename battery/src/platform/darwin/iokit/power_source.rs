...
static MAX_CAPACITY_KEY: &'static str = "AppleRawMaxCapacity"; // MaxCapacity is out of 100
static CURRENT_CAPACITY_KEY: &'static str = "AppleRawCurrentCapacity"; // "CurrentCapacity" is out of 100;  Although not sure what NominalChargeCapacity means
